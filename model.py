...
def read_predict_data(predict_data, batch_size):
    ...
    predict_data_cp2 = predict_data.copy()
    print('# Samples = ', len(predict_data))

    print("predict_data at the start of read_predict_data:", predict_data)
    ...
    print("predict_data in read_predict_data:", predict_data)

    pep_inputs, hla_inputs = make_data(predict_data_cp)
    data_loader = Data.DataLoader(MyDataSet(pep_inputs, hla_inputs), batch_size, shuffle = False, num_workers = 0)
    return predict_data_cp2, pep_inputs, hla_inputs, data_loader
